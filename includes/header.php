...
<header>
  ...
  <!-- -->
  <a id='indId1' class="navbar-brand rounded" href=""><!-- <img style='width:205px!important;height:70px!important;display:none' id='stajlLogo1'
        src='./images/menuMenuLogo1.png' alt='img' /> -->
...
<h6 style="color: black !important;">
        ...
        <a style='color:black!important;line-height:2' href='tel:+4915155778431'>+49 151 55778431</a><br>
  ...
  <!-- -->
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto justify-content-end d-flex flex-fill">
        <li class="nav-item">
          <a id='galleryBtn' class="nav-link nvLink" href="./index.php#scrollerId">Galerie </a>
        </li>
        <li class="nav-item">
          <a class="nav-link nvLink" href="./info.php">Informationen</a>
        </li>
        <li class="nav-item">
          <a class="nav-link nvLink" href="./rentDetail.php">Vermietung</a>
        </li>
        <li class="nav-item">
          <a id='kontBtn' class="nav-link nvLink" href="./contactDetail.php">Kontakt</a>
        </li>
      </ul>
    </div>
  </nav>
