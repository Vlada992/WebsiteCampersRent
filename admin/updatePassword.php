...
echo "<br><h3 class='adminH3'>Hallo " . $_SESSION['userName'] . "!</h3>";
?>
...
?>
<h2 class='adminH3' style='margin-top:4%;margin-bottom:3%'>Passwort erneuern</h2>
<?php
...
?>
<form class='adminIndexFormLogin'  method="post" action="updatePasswordExecute.php">
<label for="password"><b>Neues Kennwort</b></label><br> <!-- new password -->
...
<!-- kraj Nebojšinog koda -->
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="#"> <a href='#'>Passwort erneuern</a></li>
        </ol>
    </nav>
    <br>
<?php 
