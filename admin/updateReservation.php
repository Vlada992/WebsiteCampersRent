...
echo "<h3 style='font-size:2rem;padding:2%' class='adminH3'>hallo " . $_SESSION['userName'] . "!</h3>";
?>
<div class='col-lg-12 col-md-12 col-sm-12'>  <!-- div class col-4 col-4 col-4 col-4 -->
<form class='adminIndexFormLoged' action="logout.php" method="post">
<input style='padding:12%;font-weight:900;font-size:25px' class='loginAdmin1 respLogout'  type="submit" name="logout" value="Ausloggen">
</form>
</div> <!-- col-md-4 -->
<?php
}
...
<h2 class='adminH3' style='margin-top:4%;margin-bottom:4%'>Reservierung aktualisieren</h2>
<?php
...
?>
<form class='adminIndex2'  method="post" action="updateReservationExecute.php">
<label for="firstName">Vorname:</label><br>
<input type="text" name="firstName" id="firstName" value="<?php if(isset($reservation->first_name)) echo $reservation->first_name ?>" required><br>
<label for="lastName">Nachname:</label><br>
<input type="text" name="lastName" id="lastName" value="<?php if(isset($reservation->last_name)) echo $reservation->last_name ?>" required><br>
<label for="email">E-mail:</label><br>
<input type="text" name="email" id="email" value="<?php if(isset($reservation->email)) echo $reservation->email ?>" required><br>
<label for="phone">Telefon:</label><br>
<input type="text" name="phone" id="phone" value="<?php if(isset($reservation->phone)) echo $reservation->phone ?>" required><br>
<?php
if(isset($vehicles)){
echo "<br><label for=\"vehicle\">Vehicle:&nbsp;&nbsp; </label>";
echo "<select style='max-width:100%' name=\"vehicleId\" id=\"vehicle\">";
echo "<option style='max-width:100%' value=\"\">Select</option>";
foreach($vehicles as $vehicle){
echo "<option value=\"$vehicle->vehicle_id\"";
if($vehicle->vehicle_id == $reservation->vehicle_id) echo "selected";
...
<input  style='padding:2%;padding-right:10%;font-weight:900;font-size:25px' class='loginAdmin1 respLogout' type="submit" name="submit" value="Aktualisieren">
</form>
...
?>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="#"> <a href='#'>Update Reservation</a></li>
        </ol>
    </nav>
    <br>
