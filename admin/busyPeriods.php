...
echo "<td style='padding:1%;border-right:1px solid hsl(0,0%,71%);word-wrap:break-word;width:215px;'>&nbsp;&nbsp;" . date("F d, Y", strtotime($period->date_start)) . "</td>";
echo "<td style='padding:1%;border-right:1px solid hsl(0,0% 71%);word-wrap:break-word;width:215px;'>&nbsp;&nbsp;" . date("F d, Y", strtotime($period->date_end)) . "</td>";
