...
!function(t, e, i) {
    ...
    function p() {
        ...
        x = n(se, "Wrapper"),
        b = n(se, "Content").append(S = n(se, "Title"), F = n(se, "Current"), P = t('<button type="button"/>').attr({
            id: Z + "Previous"
        }), K = t('<button type="button"/>').attr({
            id: Z + "Next"
        }), R = n("button", "Slideshow"), M),
    ...
    function w() {
        ...
        _.get("inline")) {
            ...
            U = _.get("createImg"),
            t(U).addClass(Z + "Photo").bind("error." + Z, function() {
                ...
                d === le && setTimeout(function() {
                    ...
                    W[1] && (_.get("loop") || W[A + 1]) && (U.style.cursor = "pointer",
    ...
    J.position = function(e, i) {
        function n() {
            ...
            b[0].style.height = C[0].style.height = H[0].style.height = parseInt(y[0].style.height, 10) - j + "px"
        }
    ...
    J.prep = function(i) {
        ...
        if ($) {
            ...
            d = function() {
                ...
                I.show(),
                a > 1 ? ("string" == typeof _.get("current") && F.html(_.get("current").replace("{current}", A + 1).replace("{total}", a)).show(),
    ...
    ,
    J.next = function() {
        !q && W[1] && (_.get("loop") || W[A + 1]) && (A = h(1),
        f(W[A]))
    }
    ,
    J.prev = function() {
        !q && W[1] && (_.get("loop") || A) && (A = h(-1),
        f(W[A]))
    }
    ,
    J.close = function() {
