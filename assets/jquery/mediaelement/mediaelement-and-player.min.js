...
mejs.MediaFeatures = {
    init: function() {
        ...
        c.svgAsImg = !!document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1");
...
mejs.HtmlMediaElementShim = {
    ...
    createPlugin: function(a, b, c, d, e, f) {
        ...
        ("flash" === a.method || "silverlight" === a.method) && (i = ["id=" + m, "isvideo=" + (a.isVideo ? "true" : "false"), "autoplay=" + (d ? "true" : "false"), "preload=" + e, "width=" + k, "startvolume=" + b.startVolume, "timerrate=" + b.timerRate, "flashstreamer=" + b.flashStreamer, "height=" + l, "pseudostreamstart=" + b.pseudoStreamingStartQueryParam],
        ...
        case "vimeo":
            ...
            o.innerHTML = '<iframe src="' + a.scheme + "player.vimeo.com/video/" + n.vimeoid + "?api=1&portrait=0&byline=0&title=0&player_id=" + s + '" width="' + k + '" height="' + l + '" frameborder="0" class="mejs-shim" id="' + s + '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>',
            "function" == typeof $f) {
...
mejs.YouTubeApi = {
    ...
    enqueueIframe: function(a) {
        this.isLoaded ? this.createIframe(a) : (this.loadIframeApi(a),
          ...
          , c = new YT.Player(a.containerId,{
            ...
            events: {
                onReady: function() {
                    ...
                    a.pluginMediaElement.pluginElement = document.getElementById(a.containerId),
...
function(a) {
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        showControls: function(a) {
            ...
            b.controlsAreVisible || (a ? (b.controls.removeClass("mejs-offscreen").stop(!0, !0).fadeIn(200, function() {
                b.controlsAreVisible = !0,
                b.container.trigger("controlsshown")
            }),
            b.container.find(".mejs-control").removeClass("mejs-offscreen").stop(!0, !0).fadeIn(200, function() {
                b.controlsAreVisible = !0
            })) : (b.controls.removeClass("mejs-offscreen").css("display", "block"),
            b.container.find(".mejs-control").removeClass("mejs-offscreen").css("display", "block"),
            b.controlsAreVisible = !0,
            b.container.trigger("controlsshown")),
            b.setControlsSize())
        },
        hideControls: function(b) {
            ...
            c.container.find(".mejs-control").stop(!0, !0).fadeOut(200, function() {
                a(this).addClass("mejs-offscreen").css("display", "block")
            })) : (c.controls.addClass("mejs-offscreen").css("display", "block"),
        ...
        setControlsSize: function() {
            ...
            if (b.container.is(":visible") && e.length && e.is(":visible")) {
                ...
                do
                    ...
                    d--);
                while (null !== i && i.top.toFixed(2) > 0 && d > 0);b.container.trigger("controlsresize")
            }
        },
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildprogress: function(b, c, d, e) {
            ...
            m.bind("keydown", function(a) {
                ...
                return f = 0 > f ? 0 : f >= d ? d : Math.floor(f),
                q = new Date,
                r || e.pause(),
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        updateCurrent: function() {
            ...
            isNaN(b) && (b = 0),
            a.currenttime && a.currenttime.html(mejs.Utility.secondsToTimeCode(b, a.options))
        },
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
            ...
            if (b.isVideo) {
                ...
                var f = this
                  ...
                  , h = a('<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="' + f.id + '" title="' + f.options.fullscreenText + '" aria-label="' + f.options.fullscreenText + '"></button></div>').appendTo(c).on("click", function() {
                    ...
                    "plugin-hover" == f.fullscreenMode && (null !== g && (clearTimeout(g),
                    delete g),
                    g = setTimeout(function() {
                        e.hideFullscreenButton()
                    }, 1500))
                });
                if (b.fullscreenBtn = h,
        ...
        detectFullscreenMode: function() {
            ...
            a.createPluginClickThrough()) : b = "plugin-hover" : b = "fullwindow",
            a.fullscreenMode = b,
            b
        },
            ...
            if (!b.isPluginClickThroughCreated) {
                ...
                fullscreenBtn.on("mouseover", function() {
                    if (!b.isFullScreen) {
                        ...
                        media.positionFullscreenButton(a.left - d.left, a.top - d.top, !1),
                ...
                media.addEventListener("fullscreenchange", function(a) {
                    ...
                    b.isFullScreen ? b.media.removeEventListener("click", b.clickToPlayPauseCallback) : b.media.addEventListener("click", b.clickToPlayPauseCallback),
                    f()
                }),
        ...
        enterFullScreen: function() {
            var b = this;
            return mejs.MediaFeatures.hasiOSFullScreen ? void b.media.webkitEnterFullscreen() : (a(document.documentElement).addClass("mejs-fullscreen"),
            b.normalHeight = b.container.height(),
            b.normalWidth = b.container.width(),
            "native-native" === b.fullscreenMode || "plugin-native" === b.fullscreenMode ? (mejs.MediaFeatures.requestFullScreen(b.container[0]),
            ...
            }, 1e3)) : "fullwindow" == b.fullscreeMode,
        ...
        buildtracks: function(b, c, d, e) {
            if (0 !== b.tracks.length) {
                ...
                b.container.hover(function() {
                    b.hasChapters && (b.chapters.removeClass("mejs-offscreen"),
