...
function Swipe(t, n) {
    ...
    function e() {
        ...
        for (var e = 0; e < b.length; e++)
            8 == b[e].nodeType && (k.removeChild(b[e]),
            --e);
        y = b.length,
        b.length < 2 && (n.continuous = !1),
        w.transitions && n.continuous && b.length < 3 && (k.appendChild(b[0].cloneNode(!0)),
        ...
        for (var i = b.length; i--; ) {
            ...
            w.transitions && (o.style.left = i * -L + "px",
            f(i, D > i ? -L : i > D ? L : 0, 0))
        }
        n.continuous && w.transitions && (f(l(D - 1), -L, 0),
        f(l(D + 1), L, 0)),
        ...
        for (var t = n.menu.childNodes, e = 0; e < t.length; e++)
            if (t[e].className && -1 != t[e].className.indexOf("slider-prev"))
                ...
                for (var a = 0; y > a; a++) {
                    ...
                    i(r, "click", function(t) {
                        return function(n) {
                            o(n),
                            E(),
                            v(parseInt(this.getAttribute ? this.getAttribute("data-index") : t.attributes["data-index"].nodeValue))
                        }
                    }(r)),
                    t[e].appendChild(r)
                }
    ...
    function s() {
        for (var t = 0; y > t; t++) {
            ...
            n.className = parseInt(n.getAttribute ? n.getAttribute("data-index") : n.attributes["data-index"].nodeValue) == N ? "active" : ""
        }
    }
    function c() {
        for (var t = I.dots.childNodes; t.length > 0; )
            I.dots.removeChild(t[0]);
        a(I.prev, "click", O.prev),
        a(I.next, "click", O.next)
    }
    function d() {
    ...
    function v(t, e) {
        if (D != t) {
            if (w.transitions) {
                ...
                for (var a = Math.abs(D - t) - 1; a--; )
                    f(l((t > D ? t : D) - a - 1), L * i, 0);
                t = l(t),
                f(D, L * i, e || z),
                f(t, 0, e || z),
                n.continuous && f(l(t - i), -(L * i), 0)
            } else
                t = l(t),
                m(D * -L, t * -L, e || z);
            D = t,
    ...
    function m(t, e, i) {
        if (!i)
            return void (k.style.left = e + "px");
        var o = +new Date
          , a = setInterval(function() {
            var r = +new Date - o;
            return r > i ? (k.style.left = e + "px",
            S && p(),
            n.transitionEnd && n.transitionEnd.call(event, N, b[D]),
            void clearInterval(a)) : void (k.style.left = (e - t) * (Math.floor(r / i * 100) / 100) + t + "px")
        }, 4)
    }
    function p() {
        A = setTimeout(u, S)
    ...
    var x = function() {}
      ...
      , w = {
        ...
        transitions: function(t) {
            ...
            for (var e in n)
                if (void 0 !== t.style[n[e]])
                    return !0;
            return !1
        }(document.createElement("swipe"))
    };
    if (t) {
        var b, T, L, y, k = t.children[0];
        n = n || {};
        ...
        var A, C, I = {}, O = {}, S = n.auto || 0, P = {}, V = {}, X = {
            ...
            move: function(t) {
                if (!(t.touches.length > 1 || t.scale && 1 !== t.scale)) {
                    ...
                    C || (t.preventDefault(),
                    E(),
                    n.continuous ? (h(l(D - 1), V.x + T[l(D - 1)], 0),
                    h(D, V.x + T[D], 0),
                    h(l(D + 1), V.x + T[l(D + 1)], 0)) : (V.x = V.x / (!D && V.x > 0 || D == b.length - 1 && V.x < 0 ? Math.abs(V.x) / L + 1 : 1),
                    h(D - 1, V.x + T[D - 1], 0),
                    h(D, V.x + T[D], 0),
                    h(D + 1, V.x + T[D + 1], 0)))
                }
                ...
                n.continuous && (i = !1);
                var o = V.x < 0;
                C || (e && !i ? (o ? (n.continuous ? (f(l(D - 1), -L, 0),
                f(l(D + 2), L, 0)) : f(D - 1, -L, 0),
                f(D, T[D] - L, z),
                f(l(D + 1), T[l(D + 1)] - L, z),
                D = l(D + 1)) : (n.continuous ? (f(l(D + 1), L, 0),
                f(l(D - 2), -L, 0)) : f(D + 1, L, 0),
                f(D, T[D] + L, z),
                f(l(D - 1), T[l(D - 1)] + L, z),
                D = l(D - 1)),
                N = M ? D % 2 : D,
                n.menu && s(),
                n.callback && n.callback(N, b[D])) : n.continuous ? (f(l(D - 1), -L, z),
                f(D, 0, z),
                f(l(D + 1), L, z)) : (f(D - 1, -L, z),
                f(D, 0, z),
                f(D + 1, L, z))),
            ...
            transitionEnd: function(t) {
                parseInt(t.target.getAttribute("data-index"), 10) == D && (S && p(),
                n.transitionEnd && n.transitionEnd.call(t, N, b[D]))
            }
        };
        return e(),
        n.menu && r(),
        S && p(),
        w.addEventListener ? (w.touch && k.addEventListener("touchstart", X, !1),
        w.transitions && (k.addEventListener("webkitTransitionEnd", X, !1),
        k.addEventListener("msTransitionEnd", X, !1),
        k.addEventListener("oTransitionEnd", X, !1),
        k.addEventListener("otransitionend", X, !1),
        k.addEventListener("transitionend", X, !1)),
        window.addEventListener("resize", X, !1)) : window.onresize = function() {
            e()
        }
        ,
        {
            ...
            kill: function() {
                ...
                for (var t = b.length; t--; ) {
                    ...
                    n.style.width = "",
                    n.style.left = "",
                    w.transitions && h(t, 0, 0)
                }
                w.addEventListener ? (k.removeEventListener("touchstart", X, !1),
                ...
                window.removeEventListener("resize", X, !1)) : window.onresize = null,
                c()
            }
        }
    }
